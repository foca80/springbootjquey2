    ...
    age.keypress(function(key){
        if(key.charCode > 48 && key.charCode < 57){
            if(age.val().length < 3){
                ...
                alertUsing("3 Superaste!", false);
                return false;
            }
        }else{
            alertUsing("Ingrese el número.", false);
            return false;
        }
    });
          ...
          success: function(data) {
            ...
            for (var i in users) {
                ...
                append("<tr> \
                            ...
                            <td>" +  users[i].age + "</td> \
                            <td>" +  users[i].book + "</td> \
                            <td> \ <button id='delete' class='btn btn-danger'>Borrar</button> \
                           <button id='edit' class='btn btn-warning'>Actualizar</button> \ </td> \
                        </tr>");
            }
          },
          error: function(data) { 
